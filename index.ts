...
if (process.env.CI == 'true') {
    ...
    repo_source = core.getInput('repo_source')
...
LabelSyncer.syncLabels(octokit, owner_source, repo_source, owner_target, repo_target)
                ...
                switch (process.env.GITHUB_EVENT_NAME) {
                    case 'issue_comment':
                        ...
                        octokit
                            ...
                            .then(response => {
                                ...
                                GitHub.getIssueNumberByTitle(octokit, owner_target, repo_target, issue.title).then(
                                    targetIssueNumber => {
                    ...
                    case 'issues':
                        ...
                        switch (payload.action) {
                                    ...
                                    .then(response => {
                                        ...
                                        octokit
                                            .request('PATCH /repos/{owner}/{repo}/issues/{issue_number}', {
                                                ...
                                                body:
                                                    issue.body +
                                                    '\n\nNote: This issue has been copied to ' +
                            ...
                            case 'labeled':
                            case 'unlabeled':
                                GitHub.getIssueNumberByTitle(octokit, owner_target, repo_target, issue.title)
